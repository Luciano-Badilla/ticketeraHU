...
<div class="relative group">
    ...
    <div id="dropdown-menu-{{ $uniqueId }}"
        ...
        style="min-width: 100%; max-height: 500px; overflow-y: auto; overflow-x: hidden; z-index: 50; display: none;">
        ...
        <input id="search-input-{{ $uniqueId }}" type="text"
            ...
            placeholder="Buscar..." autocomplete="off" style="overflow-x: hidden;">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const searchInputs = document.querySelectorAll('[id^="search-input-"]');
        searchInputs.forEach(searchInput => {
            const uniqueId = searchInput.id.split('-').pop();
            const dropdownMenu = document.getElementById(`dropdown-menu-${uniqueId}`);
